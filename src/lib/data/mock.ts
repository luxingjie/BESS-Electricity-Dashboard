...
export const MOCK_SIGNALS: Signal[] = [
  {
    ...
    reviewer_note: "来源可靠，内容已核实", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "征求意见阶段，需持续跟踪正式版", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "重大政策，影响全美储能市场准入", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "影响储能项目经济模型", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "国家层面顶层政策，影响深远", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "亚太重点市场规则更新", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
  {
    ...
    reviewer_note: "拉美储能政策样本", review_status: "published", published_at: now,
    created_at: now, updated_at: now, is_demo: true, reviewed_at: now,
  },
];
